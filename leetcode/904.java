...
// slide the window whenever the new item is encountered and find the best suitable window for finding the optimal solution 
// largest subarray having two unique items with max occurances // hashmaps 
